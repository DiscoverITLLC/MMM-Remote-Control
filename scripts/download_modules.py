...
if __name__ == "__main__":
    ...
    parser.add_argument('-u', '--url', nargs='?', default='https://raw.githubusercontent.com/wiki/DiscoverITLLC/MagicMirror/MagicMirror%C2%B2-Modules.md', help='url to extract modules from')
