...
- `undefined` modules generated by the `disabled` tag are now handled. (DiscoverITLLC/MagicMirror#2382)
...
- Updates to `remote.html` to support new `basePath` feature in MM `config.js`, [follow up to this MM issue](https://github.com/DiscoverITLLC/MagicMirror/issues/1973), related to #185
...
### Fixed
- Icon paths adapted to changes in [Magic Mirror²](https://github.com/DiscoverITLLC/MagicMirror) 2.1.0
...
- Automatic installer/updater includes hint to restart [Magic Mirror²](https://github.com/DiscoverITLLC/MagicMirror)
...
- Modules sometimes did not show correctly in the UI as hidden or shown:
    - This is due to a bug in [Magic Mirror²](https://github.com/DiscoverITLLC/MagicMirror)
    - PR [#659](https://github.com/DiscoverITLLC/MagicMirror/pull/659) to fix this was made in the project, will be released in the next version
